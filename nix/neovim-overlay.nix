...
let
  ...
  all-plugins = with pkgs.vimPlugins; [
    ...
    # autoformat
    conform-nvim # autoformat | https://github.com/stevearc/conform.nvim/
    # ^ autoformat
    ...
    todo-comments-nvim # Highlight todo, notes, etc in comments | https://github.com/folke/todo-comments.nvim/
    # ^ navigation/editing enhancement plugins
